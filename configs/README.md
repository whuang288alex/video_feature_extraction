...
- video_dir_path: The directory (ABSOLUTE PATH) where the input videos are stored (all the videos in this directory will be processed)

- out_path: The directory (ABSOLUTE PATH) where the extraced features will be stored
...
(To customize cropping options, please go to models/model_name.py and modify the get_transform method)
