...
checkpoint_paths = {
    ...
    "slowfast_r101": os.path.join(root_dir, "SLOWFAST_8x8_R101.pyth"),
    "slowfast_16x8_r101_50_50": os.path.join(root_dir, "SLOWFAST_16x8_R101_50_50.pyth"),
}

def build_slowfast( version: str = "", pretrained: bool = True)-> nn.Module:
    assert version != ""
    if version == "slowfast_r50":
        return slowfast_r50(pretrained)
    elif version == "slowfast_r50_detection":
        return slowfast_r50_detection(pretrained)
    elif version == "slowfast_r101":
        return slowfast_r101(pretrained)
    elif version == "slowfast_16x8_r101_50_50":
        return slowfast_16x8_r101_50_50(pretrained)
    else:
